...
CREATE TABLE orders (
    ...
    payment_method ENUM('COD', 'VNPAY', 'MOMO', 'PAYPAL') DEFAULT 'COD',
    status ENUM('PENDING', 'CONFIRMED', 'PACKING', 'SHIPPING', 'DELIVERED', 'CANCELLED', 'REFUNDED') DEFAULT 'PENDING',
    note TEXT,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE payments (
    ...
    method ENUM('COD', 'VNPAY', 'MOMO', 'PAYPAL'),
...
CREATE TABLE deliveries (
    ...
    CONSTRAINT fk_deliveries_shipper FOREIGN KEY(shipper_id) REFERENCES shippers(id) ON DELETE SET NULL
);
...
INSERT INTO roles(name) VALUES ('ROLE_ADMIN'), ('ROLE_CUSTOMER'), ('ROLE_SHIPPER');

-- =========================================================
-- SAMPLE PRODUCTS
-- =========================================================

INSERT INTO brands(name) VALUES ('Logitech'), ('Samsung'), ('Sony');
